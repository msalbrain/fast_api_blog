...
@router.get("/home")
async def index(limit: Optional[int] = 0):


    list_of_post = []
    post_list_db = collection.find()
    for i in post_list_db:
        print(i["image"])
        template = f"""
                                 ...
                                 <div class="media blog-thumb">
                                  <div class="media-object media-left">
                                       <a href="http://127.0.0.1:8000/blog/{i["_id"]}"><img src="http://127.0.0.1:8000/images/{i["image"]}" class="img-responsive" alt=""></a>
                                  </div>
                                  <div class="media-body blog-info">
                                       <small><i class="fa fa-clock-o"></i>{i["date_created"]}</small>
                                       <h3><a href="http://127.0.0.1:8000/blog/{i["_id"]}">{i["title"]}</a></h3>
                                       <p>{i["mini_detail"]}</p>
                                       <a href="http://127.0.0.1:8000/blog/{i["_id"]}" class="btn section-btn">Read more</a>
                                  </div>
                             </div>
                        </div>
    ...
    -->
         ...
         <link rel="stylesheet" href="http://127.0.0.1:8000/font/font-awesome.min.css">

         <!-- MAIN CSS -->
         <link rel="stylesheet" href="http://127.0.0.1:8000/css/templatemo-style.css">
    </head>
    <body>
                        ...
                        <div class="col-md-6 col-sm-12">
                             <div class="home-video">
                                  <div class="embed-responsive embed-responsive-16by9">
                                       <iframe src="https://www.youtube.com/watch?v=6mRbDEtDoyA" frameborder="0" allowfullscreen></iframe>
                                  </div>
                             </div>
                        </div>
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                             <div class="about-image">
                                  <img src="http://127.0.0.1:8000/images/about-image.jpg" class="img-responsive" alt="">
                             </div>
                        </div>
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                             ...
                             <div class="work-thumb">
                                  <a href="http://127.0.0.1:8000/images/work-image1.jpg" class="image-popup">
                                       <img src="http://127.0.0.1:8000/images/work-image1.jpg" class="img-responsive" alt="Work">
                        ...
                        <div class="col-md-3 col-sm-6">
                             <!-- WORK THUMB -->
                             <div class="work-thumb">
                                  <a href="http://127.0.0.1:8000/images/work-image2.jpg" class="image-popup">
                                       <img src="http://127.0.0.1:8000/images/work-image2.jpg" class="img-responsive" alt="Work">
                        ...
                        <div class="col-md-3 col-sm-6">
                             <!-- WORK THUMB -->
                             <div class="work-thumb">
                                  <a href="http://127.0.0.1:8000/images/work-image3.jpg" class="image-popup">
                                       <img src="http://127.0.0.1:8000/images/work-image3.jpg" class="img-responsive" alt="Work">
                        ...
                        <div class="col-md-3 col-sm-6">
                             <!-- WORK THUMB -->
                             <div class="work-thumb">
                                  <a href="http://127.0.0.1:8000/images/work-image4.jpg" class="image-popup">
                                       <img src="http://127.0.0.1:8000/images/work-image4.jpg" class="img-responsive" alt="Work">
    	...
    	-->
         ...
         <script src="http://127.0.0.1:8000/js/jquery.stellar.min.js"></script>
         <script src="http://127.0.0.1:8000/js/jquery.magnific-popup.min.js"></script>
...
def blog(id: int):
    ...
    if not data:
         raise(HTTPException(status_code=status.HTTP_404_NOT_FOUND,detail = f"sorry the post with id {id} not found"))
    blog_html = f"""
    <!DOCTYPE html>
<html lang="en">
<head>
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="http://127.0.0.1:8000/home/" class="navbar-brand">Hydro</a>
               </div>

               <!-- MENU LINKS -->
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         <li><a href="http://127.0.0.1:8000/home/" class="smoothScroll">Home</a></li>
                         <li><a href="http://127.0.0.1:8000/home/" class="smoothScroll">About</a></li>
                         <li><a href="http://127.0.0.1:8000/home/" class="smoothScroll">Blog</a></li>
                         <li><a href="http://127.0.0.1:8000/home/" class="smoothScroll">Our Work</a></li>
                         <li><a href="http://127.0.0.1:8000/home/" class="smoothScroll">Contacts</a></li>
                    </ul>
                    ...
                    <div class="col-md-offset-1 col-md-10 col-sm-12">
                         ...
                         <div class="blog-detail-thumb">
                              <div class="blog-image">
                                   <img src="http://127.0.0.1:8000/images/cat.jpg" class="img-responsive" alt="Blog Image">
                              </div>
                              <h2></h2>
                              <p>{data["detail"]}</p>
